  ...
  const reviews = [
    {
      id: 1,
      name: 'Анна Петрова',
      text: 'Заказываю овощную корзину уже 3 месяца. Качество продуктов всегда на высоте! Особенно радует, что все местное и свежее.',
      rating: 5,
    ...
    },
    {
      id: 2,
      name: 'Иван Сидоров',
      text: 'Отличный сервис! Настроил корзину под свои предпочтения, исключил картофель и лук. Привозят именно то, что нужно.',
      rating: 4,
    ...
    },
    {
      id: 3,
      name: 'Мария Иванова',
      text: 'Как мама двоих детей, очень ценю качественные продукты. Дети стали лучше кушать овощи, когда они свежие и вкусные.',
      rating: 5,
